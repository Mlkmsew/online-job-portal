          ...
          <div className="mt-2 h-2.5 w-full overflow-hidden rounded-full bg-slate-100">
            <div
              className={`h-full rounded-full transition-all duration-500 ${
                result.verificationScore >= 80 ? 'bg-blue-500' : result.verificationScore >= 50 ? 'bg-amber-500' : 'bg-rose-500'
              }`}
              ...
              <div className="h-2 w-40 overflow-hidden rounded-full bg-slate-100">
                <div
                  className={`h-full rounded-full ${
                    item.verificationScore >= 80 ? 'bg-blue-500' : item.verificationScore >= 50 ? 'bg-amber-500' : 'bg-rose-500'
                  }`}
            ...
            {uploading && (
              <div className="mt-4 space-y-2">
                ...
                <div className="h-2.5 w-full overflow-hidden rounded-full bg-slate-100">
                  <div className="h-full rounded-full bg-[#1769E0] transition-all duration-300" style={{ width: `${progress}%` }} />
                </div>
              </div>
            )}
