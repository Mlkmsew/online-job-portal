...
const Contact = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#F3F9F7]">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-white/70 via-white/45 to-[#F3F9F7]" />
        </div>
      ...
      <div className="container-custom relative z-10 px-4 pb-24">
        <div className="grid gap-8 lg:grid-cols-5">
          ...
          <div className="rounded-[22px] bg-white p-6 shadow-xl sm:p-8 lg:col-span-3 lg:p-10">
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-14 text-center">
                ...
                <p className="mt-3 max-w-md text-[#536273]">
                ...
                <button
                  ...
                  className="mt-8 rounded-xl border border-[#1769E0] px-6 py-3 text-sm font-semibold text-[#1769E0] transition hover:bg-[#EAF2FE]"
                >
          ...
          {/* RIGHT — GET IN TOUCH */}
          <aside className="rounded-[22px] border border-white/60 bg-white/70 p-6 shadow-xl backdrop-blur-md sm:p-8 lg:col-span-2 lg:p-10">
            ...
            <div className="mt-8 divide-y divide-[#D8E2DF]">
              {contactBlocks.map((block) => (
                <div key={block.title} className="flex gap-4 py-6 first:pt-0 last:pb-0">
                  ...
                  <div>
                    <p className="font-semibold text-[#0F1F33]">{block.title}</p>
                    <div className="mt-2 space-y-1">
                      {block.items.map((item, i) =>
                        block.icon === FiMail ? (
                          ...
                          <p key={i} className="text-sm text-[#536273]">
                            {item}
                          </p>
                        )
                      )}
