        ...
        return (
          ...
          >
            <div>
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  className={`rounded-xl p-2.5 transition-all ${
                    isSaved
                      ? 'bg-[#EAF2FE] text-[#1769E0]'
                      : 'bg-slate-50 text-slate-400 hover:bg-slate-100 hover:text-[#1769E0]'
                  }`}
              ...
              <div className="mt-4 space-y-1.5">
                <Link
                  ...
                  className="text-base font-bold text-slate-900 group-hover:text-[#1769E0] transition line-clamp-1"
                >
            ...
            <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between gap-3">
              ...
              <Link
                to={`/jobs/${job.slug || job._id}`}
                className="inline-flex items-center gap-1 rounded-xl bg-[#EAF2FE] hover:bg-[#0D5BC4] text-[#1769E0] hover:text-white px-4 py-2 text-xs font-bold transition-all shadow-2xs"
              >
