            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div style={{ marginLeft: '20px' }}>
                {view.photo ? (
                  ...
                  <div style={{ width: '90px', height: '90px', backgroundColor: '#e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '22px', fontWeight: 'bold', color: '#4b5563', borderRadius: '2px' }}>
                    {initials}
                  </div>
                )}
              </div>
