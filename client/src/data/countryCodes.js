const countryOptions = [
  ...
  { code: '+1268', label: 'Antigua & Barbuda', flag: '🇦🇬' },
  ...
  { code: '+1849', label: 'Dominican Republic', flag: '🇩🇴' },
  { code: '+592', label: 'Ecuador', flag: '🇪🇨' },
  ...
  { code: '+1869', label: 'Saint Kitts & Nevis', flag: '🇰🇳' },
  { code: '+1758', label: 'Saint Lucia', flag: '🇱🇨' },
  { code: '+590', label: 'Saint Martin', flag: '🇲🇫' },
  { code: '+508', label: 'Saint Pierre & Miquelon', flag: '🇵🇲' },
  { code: '+1784', label: 'Saint Vincent & the Grenadines', flag: '🇻🇨' },
